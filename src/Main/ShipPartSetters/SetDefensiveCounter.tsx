...
function SetDefensiveCounters(props: SetterProps) {
  ...
  const handleDefensiveCounterChange = (ev: React.ChangeEvent<HTMLSelectElement>) => {
    let defensiveOption: string | null = ev.target.value;
  ...
  return (
    <>
      ...
      <div className='dropdownBlock'>
        ...
        {defensiveId && <SpecialMaterials part="Defensive Countermeasures" />}
      </div>
