...
function SetCrewQuarters(props: SetterProps) {
  ...
  const handleQuartersChange = (ev: React.ChangeEvent<HTMLSelectElement>) => {
    let quartersOption: string | null = ev.target.value;
