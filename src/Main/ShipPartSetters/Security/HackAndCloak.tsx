...
function HackAndCloak(props: SetterProps) {
  const { customShipParts, ship } = useContext(CustomShipContext);

  interface HackAndCloak {
    antiHackingSystemsId: string, 
    cloakingId: string,
  }

  const { antiHackingSystemsId, cloakingId }: HackAndCloak = customShipParts;
